...
%
Herein, we report on an active learning ML methodology that searches for the most stable crystal structures of IrO2 and IrO3 by utilizing surrogate models which optimize within a candidate data set of crystal motiffs sourced from publicly available materials databases.
%
