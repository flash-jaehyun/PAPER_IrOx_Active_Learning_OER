...
%
The application of ML surrogate models trained on expansive data sets of \latin{ab-initio} DFT data has been used to discover new materials in the vast composition-space.
%
However, surrogate model applications to the structural space of bulk-crystals, \latin{i.e.} polymorphs,
are very scarce due to the inherent bias of \latin{ab-initio} datasets towards systems with a large variety in composition but with limited structural diversity. 
%
