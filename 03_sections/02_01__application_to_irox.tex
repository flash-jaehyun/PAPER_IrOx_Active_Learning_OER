...
% | - %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Figure~\ref{fig:iro2_al}a shows a sequence generations of the AL algorithm applied to \IrOthree,
...
%
As the algorithm acquires DFT \DHf values, the GP model becomes more accurate, as evidenced by the decreasing uncertainties when comparing the the initial generations to the latter generations of the AL (\ref{fig:iro2_al}a.i-v).
%
At the top of each subplot of Figure~\ref{fig:iro2_al}a the identity of ten most stable polymorphs is tracked.
%
...
%
After only three generations (Figure~\ref{fig:iro2_al}a.ii) the GP model is sufficiently accurate to identify all top ten of the most stable polymorphs as being low in energy.
%
