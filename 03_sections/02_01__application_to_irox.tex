...
{02_figures/ml_convergence_plots/00_ml_plot_iro3_al__v18__downsampled_1200x1200.pdf}}
...
%
In practice, the approach still performs notably well because
...
%
Parity plot of the predicted and actual formation enthalpy (\DHf) for the final Gaussian regression ML models for \IrOtwo and \IrOthree predicting on either the pre-optimized (grey) or the post-optimized (blue) fingerprints of \IrOtwo and \IrOthree.
%
The final ML regresion models are trained on the DFT formation enthalpies for all structurally unique polymorphs and correspond to the final generation of the AL algorithm.
}
\end{figure*}
% __|
% =========================================================
