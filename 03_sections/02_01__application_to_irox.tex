...
%
The globally stable crystal structure has a space group number of 167 (R3c), a rhombohedral primitive cell with a formula unit of \ce{Ir_{2}O_{6}} (The extended standardized cell is displayed), and a completely corner-sharing octahedra network.
%
...
The structue is isomorphic to that of \ce{TeO_{3}}, \ce{FeF_{3}}, and other crystal systems.
%
The second most stable polymorph
(Figure~\ref{fig:iro3_al}b.ii)
is structurally very similar to Figure~\ref{fig:iro3_al}b.i,
only differing by the stacking of the alternating layers orthagonal to the c lattice vector, which increases the symmetry to a hexagonal symmetry space group (182) and reveals hexagonal pores through the c-axis.
%
