...
%
We label this structure $\alpha_{2}$-\ce{IrO_3} in Figure~\ref{fig:iro3_al}b and is only 2 meV/atom less stable than \aIrOthree, well within the margin of error for DFT.
%
