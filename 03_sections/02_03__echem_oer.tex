...
%
We note that the thermodynamic driving force toward these \IrOthree phases under OER conditions suggests that these structures may form spontaneously under reaction conditions.
%
Thus, it may be that only \latin{in situ} synthesis techniques can realize these highly oxidized phases,
as the synthesis of a metastable crystal structure at ambient conditions is unlikely.
%
Ion leaching from \ce{XIrO_{3}} materials, or oxidizing pretreatments of \IrOtwo phases are potential synthetic routes to \IrOthree.
% __|
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
