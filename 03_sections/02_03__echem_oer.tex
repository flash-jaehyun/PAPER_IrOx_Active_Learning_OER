...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% | - Paragraph start
We next performed {\it ab-initio} thermodynamic simulations to elucidate the electrochemical operational stability of \IrOx and the OER activity of the four stable polymorphs (\rIrOtwo, \aIrOthree, \rIrOthree, and \bIrOthree) computed above (Fg. XYZ).
% __|
...
%
The similar formation energies (SI XYZ) for all three \IrOthree species suggest some or all of these \IrOthree phases may be present and are stable under OER conditions.
...
%
For each polymorph, XYZ specific facets were chosen from the highest intensity x-ray diffraction peaks from powder-diffraction spectra simulated in VESTA (TEMP insert vesta ref and ref SI xrd plot) and physical intuition.
%
...
This is evident from figure \ref{scaling_relations} in the SI, which shows a clear distinction between the \IrOtwo and \IrOthree polymorphs, with \IrOthree binding on average TEMP eV weaker than \IrOtwo.
%
...
%
This discrepancy is due to our inclusion of spin-polarization in our ab-initio calculations, which was neglected in Seitz et al.
%
This discrpency was discussed in a previous publication. \ref{Strickler2019}
% __|
