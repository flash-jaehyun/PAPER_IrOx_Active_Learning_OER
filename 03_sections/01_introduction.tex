...
When simulations are used to guide the search for new materials, the stable and meta-stable crystal structures, \latin{i.e.} polymorphs,  close to the convex hull of stability must be known in order to predict the material properties.
%
...
%
These methods are fundamentally limited by the curse of dimensionality associated with exploring the highly dimensional PES,
...
In paralel, active learning frameworks utilizing surrogate models have been demonstrated to successfully speed up ab initio calculations, including structural optimizations\cite{hansen2019atomistic}, transition-state searches \cite{torres2019low}, and fitting of interatomic potentials. \cite{podryabinkin2017active}
