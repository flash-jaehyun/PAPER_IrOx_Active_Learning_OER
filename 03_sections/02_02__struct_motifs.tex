...
% | - PARAGRAPH BODY
%
As a next step we assess the stability as well as the structural variety of the DFT optimized structures, consisting of \num{384} and \num{191} unique \IrOtwo and \IrOthree polymorphs.
%
...
%
The metastability limit, defined via the procedure of Aykol \latin{et al.}~\cite{Aykol2018}, is displayed a horizontal line in (a) and (b).
}
\end{figure*}
% __| =====================================================
% =========================================================
...
%
On the other end, the highest volume (lowest density) systems sampled have atomic packing factors close to \num{0.15}.
%
...
structures with a coordination number of \num{6} (octahedral) or \num{4} (tetrahedral) were found to be most prevalent and have been highlighted in blue and red respectively in Figure~\ref{fig:E_vs_V}a,b.
%
