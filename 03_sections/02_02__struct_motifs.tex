...
% | - PARAGRAPH BODY
%
As a next step we assess the stability as well as the structural variety of the DFT optimized structures, consisting of 384 \IrOtwo and 191 \IrOthree unique polymorphs.
%
...
%
There are \num{196} and \num{75} polymorphs for \IrOtwo and \IrOthree, respectively, that are within the meta-stability line, and can therefore, in principle be synthesized.
%
...
%
For \IrOthree eight most stable systems were shown in Figure~\ref{fig:iro3_al}, and have been labeled as (1)-(8) in Figure~\ref{fig:E_vs_V}b.
%
