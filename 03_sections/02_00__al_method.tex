...
%
To this end, we do not provide any DFT training data prior to the start of the algorithm to eliminate any bias and to allow the model to quickly respond to new aquisitions.
% __|
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
