...
(1) candidate selection in which a subset of structures in the candidate space are selected based on an aquisition function,
(2) structural relaxtion into local energy minima (formation enthalpy computed),
...
%
This predicted energy landscape is then used to inform the next generation's aquisition step.
}
\end{figure*}
% __|
% =========================================================
