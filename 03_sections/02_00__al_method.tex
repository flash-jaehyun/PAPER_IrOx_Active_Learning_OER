...
which acquires structures for subsequent DFT calculations. % in the target chemical space (enthalpy of formation).
%
...
%
% , which is constructed through data mining the unique structural motifs in the OQMD and MP materials databases.
