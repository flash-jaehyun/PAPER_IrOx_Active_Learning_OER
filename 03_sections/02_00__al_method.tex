...
%
% TODO Get reference for Wigner-Seitz cell
% This one maybe
% https://journals.aps.org/pr/abstract/10.1103/PhysRev.43.804
...
% TODO Put real percent sign here
% \textbf{I'm a little dubious of this, where is it shown in SI?}
...
%
This predicted energy landscape is then used to select the next systems to calculate by selecting systems that minimize the aquisition function $U = \mu - \kappa \sigma$.
%
Here, $\mu$ and $\sigma$ are the predicted mean and uncertainty of the formation energy, respectively,
and $\kappa$ is a parameter to that weights exploitation vs exploration of the candidate space (herein set to 1).
%
