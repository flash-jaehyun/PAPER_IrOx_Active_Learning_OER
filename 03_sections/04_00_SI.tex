...
%
The hydrogenated phase was generated by manually adding hydrogen atoms to a symmetry reduced version of the \aIrOthree phase with a computational cell formula unit of \ce{Ir_2H_2O_6}.
%
...
%
Despite this, the pure oxide \aIrOthree is the preferred phase at realistic OER overpotentials of \mytilde0.2 V.
% __|
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
