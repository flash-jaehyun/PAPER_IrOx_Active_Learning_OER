...
%   * Reduce data set by eleminating structurally redundant systems
...
%
At a high-level, the procdure is to mine materials databases for entries with the desired non-element specific stoicheometry (\latin{i.e.} \ABtwo and \ABthree).
%
...
At the time that we originally mined these databases (TEMP 2018? TEMP), there were 61,471 inorganic compounds in the MP database and 435,583 entries in the OQMD database.
%
...
%
The structural classification scheme of Jain \latin{et al.} \cite{Jain2018} was then used to classify the structure and element-nonspecific stoicheometry of each structure (497,054 in total).
%
...
for which MP has 2,424 and 2341 \ABtwo and \ABthree entries, respectively,
and OQMD has 4,736 and 28,883 \ABtwo and \ABthree entries, respectively.
%
...
%
This process reduces the data set to 620 and 219 unique structures of \ABtwo and \ABthree for MP and 397 and 194 structurally unique \ABtwo and \ABthree OQMD entries.
%
% COMBAK
Combining the MP and OQMD data sets ultimately results in a dataset of 688 \ABtwo and 254 \ABthree structurally unique candidates.
%
...
% | - __old__
%
% The candidate for \IrOtwo and \IrOthree were generated from existing experimental structures in the OQMD and Materials Project databases by considering only structurally unique systems, where structural uniquness .
%
