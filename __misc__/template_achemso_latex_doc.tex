...
%%\listfiles  % Uncomment if issues aris when submitting
% __|
...
\author{Samira Siahrostami}
\email{samiras@stanford.edu}
\affiliation{
  SUNCAT Center for Interface Science and Catalysis,
  Department of Chemical Engineering,
  Stanford University,
...
\email{jkno@dtu.dk}
\affiliation{
  Centre for Atomic-scale Materials Physics,
  Physics Department,
...
\title[An \textsf{achemso} demo]
  {
  Iron-supported Graphene Catalysts for the Oxygen Reduction Reaction
...
This is just me trying to figur outt if the spell check workks.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% End of the main part of the manuscript
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
